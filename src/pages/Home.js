    ...
    <div className="background">
      ...
      <div className="centerConsole">
        ...
        <div className="questions">
          ...
          <div className="answer">
            <span className="q">WHY: </span> Driven by neurodivergency,
            caffiene, and a fervor for answers, Gavin relentlessly tackles
            problems problems and seeks out new things.
          </div>
          <div className="answer">
